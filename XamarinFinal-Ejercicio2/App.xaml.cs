    ...
    public partial class App
    {
        ...
        protected override async void OnInitialized()
        {
            ...
            if(AppSettings.Instance.Logged){
                await NavigationService.NavigateAsync(new Uri("http://template.com/Local/Navigation/HomeUser", UriKind.Absolute));
            }
            else
            {
        ...
        protected override void RegisterTypes(IContainerRegistry containerRegistry)
        {
            ...
            containerRegistry.RegisterForNavigation<MasterPage, MasterPageViewModel>("Local");
            ...
            containerRegistry.RegisterForNavigation<HomeLoginPage, HomeLoginViewModel>("HomeUser");
